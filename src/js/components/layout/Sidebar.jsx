  ...
  render() {
    ...
    return (
            <div id="sidebar-wrapper">
                ...
                <li className={quotesClass}><Link to="quotes"><i className="fa fa-quote-left"></i> Quotes</Link></li>
                <li className={weatherClass}><Link to="weather"><i className="fa fa-cloud"></i> Weather</Link></li>
                </ul>
            </div>
        );
  }
